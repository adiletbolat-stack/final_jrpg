...
public class HeavyEnemy extends BattleUnit {
    public HeavyEnemy(String name, Body body, Vector2 spawn, Vector2 rallyPoint, Color color, BattleSoundProfile soundProfile) {
        super(name, Team.ENEMY, BattleUnitType.HEAVY, body, spawn, rallyPoint, color, new HeavyEnemyMovement(), soundProfile);
    }
}
