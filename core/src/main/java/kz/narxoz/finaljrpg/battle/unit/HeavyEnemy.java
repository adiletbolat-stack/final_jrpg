...
public class HeavyEnemy extends BattleUnit {
    public HeavyEnemy(String name, Body body, Vector2 spawn, Vector2 rallyPoint, Color color, BattleSoundProfile soundProfile, String spriteKey, ObjectScale scale) {
        super(BattleUnit.builder()
            .name(name)
            .team(Team.ENEMY)
            .type(BattleUnitType.HEAVY)
            .body(body)
            .spawn(spawn)
            .rallyPoint(rallyPoint)
            .color(color)
            .movement(new HeavyEnemyMovement())
