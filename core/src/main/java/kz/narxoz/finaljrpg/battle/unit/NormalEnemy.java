...
public class NormalEnemy extends BattleUnit {
    public NormalEnemy(String name, Body body, Vector2 spawn, Vector2 rallyPoint, Color color) {
        super(name, Team.ENEMY, BattleUnitType.NORMAL, body, spawn, rallyPoint, color, new NormalEnemyMovement());
    }
}
