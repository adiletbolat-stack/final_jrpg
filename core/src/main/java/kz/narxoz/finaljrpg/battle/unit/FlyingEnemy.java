...
public class FlyingEnemy extends BattleUnit {
    public FlyingEnemy(String name, Body body, Vector2 spawn, Vector2 rallyPoint, Color color, BattleSoundProfile soundProfile) {
        super(name, Team.ENEMY, BattleUnitType.FLYING, body, spawn, rallyPoint, color, new FlyingEnemyMovement(), soundProfile);
    }
}
